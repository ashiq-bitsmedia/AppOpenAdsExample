...
class MyApplication :
  ...
  private inner class AppOpenAdManager {
    ...
    private var adLoadStartTimes: Long = 0
    ...
    fun loadAd(context: Context) {
      ...
      adLoadStartTimes = System.currentTimeMillis() // for logging purposes
      ...
      AppOpenAd.load(
        ...
        object : AppOpenAdLoadCallback() {
          ...
          override fun onAdLoaded(ad: AppOpenAd) {
            ...
            isLoadingAd = false
            loadTime = Date().time
            val loadingTime = System.currentTimeMillis() - adLoadStartTimes
            Log.d("Loading Time", "AdLoaded: $loadingTime ms")
          ...
          override fun onAdFailedToLoad(loadAdError: LoadAdError) {
            isLoadingAd = false
            val loadingTime = System.currentTimeMillis() - adLoadStartTimes
            Log.d("Loading Time", "Failed to load ad: $loadingTime ms")
